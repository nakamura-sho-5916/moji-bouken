...
export const bgmCompositions: Record<BgmId, BgmComposition> = {
  ...
  battle: createComposition({
    ...
    bass: [0, null, 0, 0, -5, null, -5, 0, 0, null, 0, 7, -3, null, -3, 7],
    pad: [
      0,
      null,
      5,
    ...
    percussion: [true, false, false, true, false, true, false, false],
    description: 'Adventurous focused battle loop with intro, A, and B phrases',
  }),
